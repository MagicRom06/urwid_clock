...
class Horloge:
    def __init__(self):
        ...
        self.boucle = urwid.MainLoop(self.horloge, palette=self.palette, unhandled_input=self.quitter)
    ...
    def configurer_horloge(self):
        ...
        self.horloge = urwid.Filler(urwid.AttrMap(urwid.Padding(self.texte_horloge, 'center', width='clip'), 'horloge'),
                                    'middle')
